        ...
        <form action="{{ route('Admin::article.store') }}" method="post">
            ...
            <div class="q5row">
                <div class="q5input-group">
                    ...
                    <input class="form-control" maxlength="60" value="{{ $article->title }}" type="text" required name="title" placeholder="请输入文章标题">
                </div>
            </div>
            <div class="q5row">
                <div class="q5input-group">
                    ...
                    <select class="form-control" name="category_id">
                        ...
                        @foreach($cates as $k=>$v)
                            <option {{ $v->id == $article->cid ? "selected" : ''}}
                        ...
                        <div class="q5clearfix">
                            <div class="curr-tags">
                                @foreach($tags_list as $k=>$v)
                                    <div class="tag-item">
                                        <span class="tag-txt">{{ $v['name'] }}</span>
            ...
            <div class="q5row">
                <input id="postarticle" type="button" class="q5btn btn-lg q5bg-blue" value="更新文章">
            </div>
        </form>
    </div>
@endsection
@section('footer')
    ...
    <script>
        tinymce.init({
            ...
            plugins: 'toc codesample print preview searchreplace autolink directionality visualchars fullscreen image ' +
