<?php if (!defined('WMBLOG')) exit; ?>
    <div id="footer">在路上 <? echo date('Y'); ?> <?php echo VER; ?> Processed <?php $t2 = microtime(true);
        echo round($t2 - $t1, 3); ?>s <a href="http://beian.miit.gov.cn" rel="nofollow"
                                         target="_blank"><?php echo $set['icp']; ?></a></div>
